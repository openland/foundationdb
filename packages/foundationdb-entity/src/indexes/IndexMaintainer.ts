...
export interface IndexMaintainer {
    onCreateLockKey?(id: TupleItem[], values: any): string;
    ...
    onUpdateLockKey?(id: TupleItem[], oldValue: any, newValue: any): string;
    ...
    onDestroyLockKey?(id: TupleItem[], values: any): string;
